...
#define SEG_VIDEO   6           //GS
#define SEG_UCODE1  7           // Child Process User code
#define SEG_UDATA1  8           // Child Process User data/stack
...
2. Multiple adjacent bit fields a re usually packed together (although this behavior is implementation-defined)
Refer: en.cppreference.com/w/cpp/language/bit_field
*/
struct SegDesc {
	uint32_t lim_15_0 : 16;  // Low bits of 0segment limit
